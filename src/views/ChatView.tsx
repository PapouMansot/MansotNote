          ...
          <div className="mx-auto max-w-3xl space-y-6">
            ...
            {messages.map((turn) => (
              ...
              >
                ...
                {turn.action && (
                  <div className="mt-1.5 w-full max-w-lg rounded-xl border border-indigo-200/90 bg-indigo-50/70 p-3.5 shadow-sm dark:border-indigo-900/70 dark:bg-indigo-950/50">
                    <div className="mb-2.5 flex items-center justify-between text-xs font-semibold text-indigo-950 dark:text-indigo-200">
